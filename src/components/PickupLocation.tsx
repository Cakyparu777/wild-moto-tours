...
const msg = (car = '') => encodeURIComponent(`Сайн уу! ${car ? car + ' машин түрээслэхийг хүсч байна.' : 'Мэдээлэл авмаар байна.'} / Hi! ${car ? `I'd like to rent the ${car}.` : "I'd like more information."}`)

const contacts = [
  {
    label: 'WhatsApp',
    href: `https://wa.me/${OWNER.whatsapp}?text=${msg()}`,
    color: '#25D366',
    hoverColor: '#1fb559',
    icon: (
  ...
  {
    label: 'Telegram',
    href: `https://t.me/${OWNER.telegram}`,
    color: '#0088cc',
    hoverColor: '#0077b5',
    icon: (
      <svg viewBox="0 0 32 32" className="w-6 h-6" fill="currentColor">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-10">
            Reach us instantly on any platform. We respond fast — usually within minutes during working hours.
          </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 mb-8 md:mb-10">
            {contacts.map((c) => (
              <a
                ...
                style={{ '--hover-bg': c.hoverColor } as React.CSSProperties}
                ...
                onMouseEnter={e => (e.currentTarget.style.backgroundColor = c.hoverColor)}
                onMouseLeave={e => (e.currentTarget.style.backgroundColor = c.color)}
                ref={el => { if (el) el.style.backgroundColor = c.color }}
              >
                {c.icon}
                {c.label}
              </a>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-white font-semibold mb-1">Pickup Address</p>
                <a
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <p className="text-white font-semibold mb-2">Mongolia Time (UTC+8)</p>
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className={`text-xs font-semibold ${isOpen ? 'text-green-400' : 'text-red-400'}`}>
                    {isOpen ? 'Available now' : 'Outside hours — message us anyway!'}
                  </span>
                </div>
