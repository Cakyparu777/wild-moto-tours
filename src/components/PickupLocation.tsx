    ...
    <section ref={ref} id="locations" className="py-12 md:py-24 px-6 sm:px-8 md:px-16 lg:px-20 bg-gray-900">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
        ...
        <div className={`anim-slide-left ${inView ? 'in-view' : ''}`}>
          ...
          >
            <div className="w-10 h-10 flex items-center justify-center shrink-0" style={{ backgroundColor: '#E1306C' }}>
              <svg viewBox="0 0 32 32" className="w-5 h-5 text-white" fill="currentColor">
                <path d="M16 4c-3.284 0-3.694.014-4.983.072-1.287.059-2.165.263-2.933.561a5.918 5.918 0 00-2.14 1.393A5.918 5.918 0 004.55 8.166c-.298.768-.502 1.646-.561 2.933C3.93 12.387 3.916 12.797 3.916 16c0 3.203.014 3.613.072 4.902.059 1.287.263 2.165.561 2.933a5.918 5.918 0 001.393 2.14 5.918 5.918 0 002.14 1.394c.768.298 1.646.502 2.933.561C12.306 28.07 12.716 28.084 16 28.084c3.284 0 3.694-.014 4.983-.072 1.287-.059 2.165-.263 2.933-.561a5.918 5.918 0 002.14-1.394 5.918 5.918 0 001.394-2.14c.298-.768.502-1.646.561-2.933.058-1.289.072-1.699.072-4.902 0-3.203-.014-3.613-.072-4.902-.059-1.287-.263-2.165-.561-2.933a5.918 5.918 0 00-1.394-2.14 5.918 5.918 0 00-2.14-1.393c-.768-.298-1.646-.502-2.933-.561C19.694 4.014 19.284 4 16 4zm0 2.162c3.225 0 3.607.012 4.88.07 1.177.054 1.816.25 2.24.416.563.219.965.48 1.387.902.422.422.683.824.902 1.387.166.424.362 1.063.416 2.24.058 1.273.07 1.655.07 4.88s-.012 3.607-.07 4.88c-.054 1.177-.25 1.816-.416 2.24a3.736 3.736 0 01-.902 1.387 3.736 3.736 0 01-1.387.902c-.424.166-1.063.362-2.24.416-1.273.058-1.655.07-4.88.07s-3.607-.012-4.88-.07c-1.177-.054-1.816-.25-2.24-.416a3.736 3.736 0 01-1.387-.902 3.736 3.736 0 01-.902-1.387c-.166-.424-.362-1.063-.416-2.24C6.174 19.607 6.162 19.225 6.162 16s.012-3.607.07-4.88c.054-1.177.25-1.816.416-2.24a3.736 3.736 0 01.902-1.387 3.736 3.736 0 011.387-.902c.424-.166 1.063-.362 2.24-.416C12.393 6.174 12.775 6.162 16 6.162zm0 3.676a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM16 20a4 4 0 110-8 4 4 0 010 8zm7.846-10.405a1.44 1.44 0 11-2.88 0 1.44 1.44 0 012.88 0z" />
              </svg>
            </div>
            <div>
              <p className="text-white font-semibold text-sm group-hover:text-pink-400 transition-colors">Visit us on Instagram</p>
