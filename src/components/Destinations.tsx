...
export default function Destinations() {
  ...
  return (
    <section className="py-12 md:py-20 px-6 sm:px-8 md:px-16 lg:px-20 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
        {d.items.map((dest, i) => (
          <div key={dest.name} className="group overflow-hidden bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
