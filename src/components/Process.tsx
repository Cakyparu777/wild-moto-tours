const steps = [
  {
    ...
    description: 'Pick the car that fits your style and budget.',
  },
  {
    number: '02',
    title: 'Select & Reserve',
    description: 'Choose your pickup date and location.',
  },
  {
    number: '03',
    title: 'Contact the Owner',
    description: 'Tap WhatsApp, Telegram, Viber, or WeChat — confirm in minutes.',
  },
]
  ...
  return (
    <section id="how-it-works" className="py-12 md:py-20 px-6 sm:px-8 md:px-16 lg:px-20 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="text-center mb-10 md:mb-14">
        <p className="text-xs font-semibold tracking-[0.25em] uppercase text-gray-400 dark:text-gray-500 mb-3">Simple & Fast</p>
